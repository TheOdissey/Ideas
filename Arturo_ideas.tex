...
\section*{TravelBox}
A web platform that prepares for city visitors a package of tickets for events that are happening during the time the tourist is visiting the city.

\section*{Unplugged}
A web platform for party organisers to rent out amateur music bands that have no agent. 

\section*{NeverIdle}
A web platform that allows owners of machinery that is idle most of the time to sell out the machinery usage to people that live within a certain distance from them
